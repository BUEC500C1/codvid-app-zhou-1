...
import { Button, FlatList, StyleSheet, ScrollView, View, Text, TextInput, TouchableOpacity, Dimensions }from 'react-native';
...
export default class FifthPage extends Component {
  ...
  static navigationOptions = ({ navigation }) => {
    return {
      ...
      title: navigation.getParam('Title', 'World Map'),
      //Heading style
      headerStyle: {
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <Text style={{fontWeight: "bold"}}> World Map {"\n"} </Text>
